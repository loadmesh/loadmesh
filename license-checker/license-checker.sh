...
$LICENSE_CHECKER -a -r -i model/protocol ./license-checker/license-header.txt . go java
$LICENSE_CHECKER -a -r ./license-checker/license-header.txt . proto
$LICENSE_CHECKER -a -r -i .chglog ./license-checker/license-header-sh.txt . sh yaml yml
$LICENSE_CHECKER -a -r -i .chglog,CHANGELOG.md ./license-checker/license-header-md.txt . md
